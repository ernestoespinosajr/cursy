...
final class CompanionManager: ObservableObject {
            ...
            do {
                ...
                if let pointCoordinate = parseResult.coordinate,
                   let targetScreenCapture {
                    ...
                    CursyAnalytics.trackElementPointed(elementLabel: parseResult.elementLabel)
    ...
    private func speakCreditsErrorFallback() {
        let utterance = "I'm temporarily unavailable. Please contact hello at hellocursy dot com."
    ...
    func setupOnboardingVideo() {
        ...
        // Cursy flies to something interesting on screen and comments on it
        let demoTriggerTime = CMTime(seconds: 40, preferredTimescale: 600)
        onboardingDemoTimeObserver = player.addBoundaryTimeObserver(
            forTimes: [NSValue(time: demoTriggerTime)],
            queue: .main
        ) { [weak self] in
            CursyAnalytics.trackOnboardingDemoTriggered()
